...
import type { LoadedClaudeData, ProjectMatch, ThreadRow, TranscriptMetadata } from "./types.js";
...
export function filterThreadsForProject(data: LoadedClaudeData, projectRoot: string): ThreadRow[] {
